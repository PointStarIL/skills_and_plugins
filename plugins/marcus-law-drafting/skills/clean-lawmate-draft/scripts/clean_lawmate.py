...
hebrew-docx-engine, שמחזיק את התבנית והסגנונות בשם: Normal, List Paragraph
...
# Shared engine: the hebrew-docx-engine skill is the single source of truth
# for styles/template/RTL — all DOCX generation routes through it.
sys.path.insert(0, str(
    Path(__file__).resolve().parents[2] / "hebrew-docx-engine" / "scripts"))
