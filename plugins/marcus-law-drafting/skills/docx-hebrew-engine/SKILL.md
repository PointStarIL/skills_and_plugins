...
description: >
  ...
  חלוקת תפקידים: סקיל זה אחראי על ה**עיצוב והבנייה** (איך בונים מסמך עברי).
  למבנה ולתוכן של סוגי מסמכים משפטיים (כתב טענות/הסכם/התראה), ולעריכה מתקדמת
  (tracked changes, comments, טבלאות RTL) - ראה `legal-docx`.
version: "1.1.0"
---
