...
cd ~/.claude/skills
git clone https://github.com/PleasePrompto/notebooklm-skill ask-notebooklm
...
```
~/.claude/skills/ask-notebooklm/data/
...
ls ~/.claude/skills/ask-notebooklm/
