...
cd ~/.claude/skills/ask-notebooklm
...
cp ~/.claude/skills/ask-notebooklm/data/library.json library.backup.json

# Reset library
rm ~/.claude/skills/ask-notebooklm/data/library.json
...
```bash
# Check disk usage
df -h ~/.claude/skills/ask-notebooklm/data/
...
if [ -f ~/.claude/skills/ask-notebooklm/data/library.json ]; then
    cp ~/.claude/skills/ask-notebooklm/data/library.json ~/library.backup.json
fi
...
if [ -f ~/library.backup.json ]; then
    mkdir -p ~/.claude/skills/ask-notebooklm/data/
    cp ~/library.backup.json ~/.claude/skills/ask-notebooklm/data/library.json
fi
```
...
ls -la ~/.claude/skills/ask-notebooklm/data/
```
