# סקיל hebrew-legal-pptx - גרסה מתוקנת
...
2. לך לתיקיית הסקיל המקורי:
   ```
   C:\Users\Chaim\AppData\Roaming\Claude\local-agent-mode-sessions\skills-plugin\9509084e-7913-4525-860f-da05b83a1a96\8db6e213-b9c0-4e1f-9185-f67af7939695\skills\hebrew-legal-pptx\
   ```
3. החלף את הקבצים:
