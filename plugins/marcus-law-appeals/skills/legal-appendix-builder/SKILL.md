---
name: legal-appendix-builder
description: "מארגן, ממספר וכורך נספחים של כתבי בי-דין לקובצי PDF מוכנים להגשה לבית המשפט, עם מספור בעברית או בערבית, אימות הפניות צולבות מול גוף כתב הטענות, יצירת דפי כיסוי לכל נספח, תוכן עניינים מלא וסימניות (bookmarks) ב-PDF. ממיר אוטומטית DOCX ל-PDF תוך שמירה על העיצוב המקורי של Word (באמצעות פונטים מצורפים), אוכף מרווח שורות 1.5 בגוף ו-1.15 בטבלאות, מנקה טיפוגרפיה שמסגירה כתיבת AI (em-dash), מתקן כיוון עמוד, ומתקין אוטומטית את הפונטים של Word בהפעלה ראשונה. השתמש בסקיל הזה כשצריך לכרוך נספחים, לאמת הפניות לנספחים בתוך כתב טענות, ליצור דפי כיסוי לנספחים, או להרכיב חבילת נספחים מוכנה להגשה לבית המשפט. טריגרים: נספחים, כרוך נספחים, bind appendices, appendix package, תוכן עניינים נספחים, דפי כיסוי, אימות הפניות, נספח א, appendix binding."
version: "3.1.0"
---

# legal-appendix-builder (v3.1)
